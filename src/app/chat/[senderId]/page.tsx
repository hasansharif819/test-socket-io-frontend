      ...
      <div className="h-[500px] overflow-y-auto border rounded p-4 bg-gray-100 mb-4 space-y-3">
        {messages.map((msg) => {
          ...
          return (
            ...
            >
              {!isMe && (
                <div className="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center overflow-hidden text-white font-semibold text-sm shrink-0">
              ...
              {isMe && (
                <div className="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center overflow-hidden text-white font-semibold text-sm shrink-0">
                  {/* You can also show user's own picture here if available */}
                  <span className="text-gray-700">
